  ...
  static #_ = _staticBlock = () => (this.ɵfac = function SettingsComponent_Factory(__ngFactoryType__) {
    ...
    template: function SettingsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](5, "navigate_before");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
...
function DomainStoryRenderer(eventBus, styles, canvas, textRenderer, commandStack) {
  ...
  this.drawAnnotation = function (parentGfx, element) {
    ...
    let textPathData = (0,_util_util__WEBPACK_IMPORTED_MODULE_13__.getScaledPath)({
      xScaleFactor: 1,
      yScaleFactor: 1,
...
function DSLabelEditingPreview(eventBus, canvas) {
  ...
  eventBus.on("directEditing.activate", function (context) {
    ...
    if ((0,_util_util__WEBPACK_IMPORTED_MODULE_3__.is)(element, src_app_domain_entities_elementTypes__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.TEXTANNOTATION)) {
      ...
      let textPathData = (0,_util_util__WEBPACK_IMPORTED_MODULE_3__.getScaledPath)({
        xScaleFactor: 1,
        yScaleFactor: 1,
        containerWidth: element.width,
        containerHeight: element.height,
