...
/* harmony export */ });
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
ReplaceMenuProvider.prototype.getEntries = function (element) {
  let entries;
  if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR)) {
    entries = _replaceOptions__WEBPACK_IMPORTED_MODULE_2__.actorReplaceOptions(element.type);
  } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT)) {
...
function actorReplaceOptions(name) {
  const actors = iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR);
  let replaceOption = {};
  let i = 0;
  actors.keysArray().forEach(actorType => {
    if (!name.includes(actorType)) {
      ...
      replaceOption[i] = {
        ...
        target: {
          type: `${src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR}${actorType}`
        }
      };
      i++;
    }
...
function workObjectReplaceOptions(name) {
  const workObjects = iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT);
  let replaceOption = {};
  let i = 0;
  workObjects.keysArray().forEach(workObjectType => {
    if (!name.includes(workObjectType)) {
      ...
      replaceOption[i] = {
        ...
        target: {
          type: `${src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT}${workObjectType}`
        }
      };
    }
    i++;
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
function DomainStoryContextPadProvider(connect, translate, elementFactory, create, canvas, contextPad, popupMenu, replaceMenuProvider, commandStack, eventBus, modeling, rules) {
  ...
  this.getContextPadEntries = function (element) {
    ...
    if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT)) {
    ...
    } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTOR)) {
      addDelete(actions, element);
      addColorChange(actions, element);
      addConnectWithActivity(actions, startConnect);
      addTextAnnotation(actions);
    ...
    } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.GROUP)) {
      addTextAnnotation(actions);
      addDeleteGroupWithoutChildren(actions, element);
      addColorChange(actions, element);
    } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY)) {
      addChangeDirection(actions);
      addColorChange(actions, element);
      addDelete(actions, element);
    } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.TEXTANNOTATION)) {
      addDelete(actions, element);
      addColorChange(actions, element);
    } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.CONNECTION)) {
      addDelete(actions, element);
    }
          ...
          action: {
            click: function (event, element) {
              if ((0,min_dash__WEBPACK_IMPORTED_MODULE_0__.isArray)(element)) {
                const groups = element.filter(el => el.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.GROUP));
                const otherElements = element.filter(el => !el.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.GROUP));
  ...
  function addTextAnnotation(actions) {
    (0,min_dash__WEBPACK_IMPORTED_MODULE_0__.assign)(actions, {
      "append.text-annotation": appendAction(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.TEXTANNOTATION, "bpmn-icon-text-annotation", "textannotation", "connect")
    });
  }
  ...
  function addWorkObjects(appendAction, actions) {
    let workObjects = iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT);
    workObjects.keysArray().forEach(workObjectType => {
      let name = workObjectType;
      let icon = iconDictionaryService.getCSSClassOfIcon(workObjectType);
      let action = [];
      action["append.workObject" + name] = appendAction(`${src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT}${workObjectType}`, icon, name, "workObjects");
      (0,min_dash__WEBPACK_IMPORTED_MODULE_0__.assign)(actions, action);
    });
  }
  function addActors(appendAction, actions) {
    let actors = iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTOR);
    actors.keysArray().forEach(actorType => {
      let name = actorType;
      let icon = iconDictionaryService.getCSSClassOfIcon(actorType);
      let action = [];
      action["append.actor" + name] = appendAction(`${src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTOR}${actorType}`, icon, name, "actors");
      (0,min_dash__WEBPACK_IMPORTED_MODULE_0__.assign)(actions, action);
    });
  }
  ...
  function changeDirection(element) {
    ...
    let newNumber;
    if (element.source.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTOR)) {
      newNumber = 0;
    } else {
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
DomainStoryElementFactory.prototype._getShapeSize = function (dstElementType) {
  let shapes = {
    ...
    [src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_4__.ElementTypes.TEXTANNOTATION]: {
      width: 100,
      height: 30
    },
    [src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_4__.ElementTypes.GROUP]: {
      width: 300,
      height: 200
    }
  };
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
function DomainStoryRenderer(eventBus, styles, canvas, textRenderer, commandStack) {
  ...
  function renderExternalNumber(parentGfx, element) {
    if (element && element.source) {
      ...
      if (semantic.number == null && element.source.type && element.source.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.ACTOR)) {
      ...
      if (semantic.number && element.source.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.ACTOR)) {
  ...
  this.drawActor = function (parent, element) {
    ...
    let iconSRC = _iconDictionaryService.getIconSource(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.getIconId(element.type));
...
DomainStoryRenderer.prototype.drawShape = function (p, element) {
  ...
  if (type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.ACTOR)) {
    return this.drawActor(p, element);
  } else if (type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.WORKOBJECT)) {
    return this.drawWorkObject(p, element);
  } else if (type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.TEXTANNOTATION)) {
    return this.drawAnnotation(p, element);
  } else if (type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.GROUP)) {
...
DomainStoryRenderer.prototype.drawConnection = function (p, element) {
  ...
  if (type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.ACTIVITY) {
    return this.drawActivity(p, element);
  } else if (type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_11__.ElementTypes.CONNECTION) {
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
function canConnect(source, target) {
  ...
  if (isAnnotation(target)) {
    return {
      type: src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.CONNECTION
    };
  }
  return {
    type: src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.ACTIVITY
  };
}
function canResize(shape, newBounds) {
  if ((0,_util_util__WEBPACK_IMPORTED_MODULE_4__.is)(shape, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.GROUP)) {
    if (newBounds) {
      const lowerLeft = {
        x: shape.x,
...
/* harmony import */ var _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../domain/entities/element-types */ 84967);
...
function DomainStoryUpdater(eventBus, egon, connectionDocking) {
  ...
  function updateElement(e) {
    ...
    if (shape.type === _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.GROUP) {
    ...
    if (shape.parent && "type" in shape.parent && shape.parent.type === _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.GROUP) {
...
function DSLabelEditingPreview(eventBus, canvas) {
  ...
  eventBus.on("directEditing.activate", function (context) {
    ...
    if ((0,_util_util__WEBPACK_IMPORTED_MODULE_3__.is)(element, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.TEXTANNOTATION)) {
    ...
    if ((0,_util_util__WEBPACK_IMPORTED_MODULE_3__.is)(element, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.TEXTANNOTATION) || element.labelTarget) {
      canvas.addMarker(element, MARKER_HIDDEN);
    } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTOR) || element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT) || element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY) || element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.GROUP)) {
...
function DSLabelEditingProvider(eventBus, canvas, directEditing, modeling, resizeHandles, textRenderer, updateLabelHandler) {
  ...
  eventBus.on("element.dblclick", function (event) {
    ...
    if ((0,_util_util__WEBPACK_IMPORTED_MODULE_3__.is)(event.element, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY)) {
  ...
  eventBus.on(_diagramJSConstants__WEBPACK_IMPORTED_MODULE_5__.EVENT_CREATE_END, 500, function (event) {
    ...
    if (!(0,_util_util__WEBPACK_IMPORTED_MODULE_3__.is)(element, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY)) {
...
DSLabelEditingProvider.prototype.getEditingBBox = function (element) {
  ...
  // adjust for groups
  if ((0,_util_util__WEBPACK_IMPORTED_MODULE_3__.is)(element, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.GROUP)) {
...
function getLabelAttr(semantic) {
  if (semantic.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR) || semantic.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT) || semantic.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTIVITY) || semantic.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.GROUP)) {
    return "name";
  }
  if (semantic.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.TEXTANNOTATION)) {
    return "text";
  }
}
function getNumberAttr(semantic) {
  if ((0,_util_util__WEBPACK_IMPORTED_MODULE_1__.is)(semantic, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTIVITY)) {
    return "number";
  }
}
...
function createAutocompleteForEdit(editingBox, workObjectNames, businessElement, eventBus) {
  ...
  if (!businessElement || !businessElement.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT)) {
    return;
  }
  let currentFocus, workObjectNamesFilteredBySearchterm;
  editingBox.addEventListener("input", inputFunction);
  function inputFunction() {
    if (!workObjectNames || workObjectNames.length === 0 || !businessElement || !businessElement.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT)) {
      return;
    }
    ...
    if (businessElement.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT)) {
...
/* harmony export */ });
/* harmony import */ var min_dash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! min-dash */ 81410);
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
function initPalette(actions, spaceTool, lassoTool, createAction) {
  ...
  let actorTypes = iconDictionary?.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.ACTOR);
  actorTypes?.keysArray().forEach(name => {
    addCanvasObjectTypes(name, createAction, actions, "actor", src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.ACTOR);
  });
  (0,min_dash__WEBPACK_IMPORTED_MODULE_0__.assign)(actions, {
    "actor-separator": {
      group: "actor",
  ...
  let workObjectTypes = iconDictionary?.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.WORKOBJECT);
  workObjectTypes?.keysArray().forEach(name => {
    addCanvasObjectTypes(name, createAction, actions, "actor", src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.WORKOBJECT);
  });
  (0,min_dash__WEBPACK_IMPORTED_MODULE_0__.assign)(actions, {
    ...
    "domainStory-group": createAction(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.GROUP, "group", "icon-domain-story-tool-group", "group"),
    "group-separator": {
      group: "group",
      separator: true
    },
...
/* harmony export */ });
/* harmony import */ var _util_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/util */ 84029);
/* harmony import */ var _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../domain/entities/element-types */ 84967);
/* harmony import */ var _diagramJSConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../diagramJSConstants */ 273);
...
function elementUpdateHandler(commandStack, eventBus) {
  ...
  function element_colorChange() {
    ...
    this.execute = function (context) {
      let semantic = context.businessObject;
      let element = context.element;
      if (semantic.type.includes(_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.TEXTANNOTATION) && element.incoming[0]) {
...
function UpdateLabelHandler(modeling, textRenderer, commandStack) {
  ...
  function handlerFunction() {
    ...
    this.postExecute = function (ctx) {
      ...
      if ((0,_util_util__WEBPACK_IMPORTED_MODULE_2__.is)(element, src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.TEXTANNOTATION)) {
...
/* harmony import */ var _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../domain/entities/element-types */ 84967);
...
function isOfTypeConnection(element) {
  return element.type === _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_7__.ElementTypes.ACTIVITY || element.type === _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_7__.ElementTypes.CONNECTION;
}
function isOfTypeGroup(element) {
  return element && element.type === _domain_entities_element_types__WEBPACK_IMPORTED_MODULE_7__.ElementTypes.GROUP;
}
...
/* harmony import */ var ngx_color_picker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ngx-color-picker */ 32580);
/* harmony import */ var _tools_autosave_services_autosave_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./tools/autosave/services/autosave.service */ 41707);
/* harmony import */ var _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./domain/entities/constants */ 40550);
...
/* harmony import */ var _tools_modeler_services_modeler_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./tools/modeler/services/modeler.service */ 40439);
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/router */ 47804);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/router */ 96383);
...
/* harmony import */ var src_app_tools_import_services_import_domain_story_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/app/tools/import/services/import-domain-story.service */ 93586);
...
/* harmony import */ var src_app_tools_modeler_diagram_js_features_diagramJSConstants__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! src/app/tools/modeler/diagram-js/features/diagramJSConstants */ 273);
...
class AppComponent {
  constructor() {
    ...
    this.color = _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.BLACK;
    ...
    this.colorBox = [_domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.YELLOW, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.ORANGE, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.RED, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.LIGHT_PINK, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.DARK_PINK, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.PURPLE, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.BLUE, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.CYAN, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.GREEN, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.LIME, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.GREY, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.BLACK];
    ...
    this.exportService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_tools_export_services_export_service__WEBPACK_IMPORTED_MODULE_3__.ExportService);
    this.autosaveService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_tools_autosave_services_autosave_service__WEBPACK_IMPORTED_MODULE_7__.AutosaveService);
    ...
    this.replayService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_tools_replay_services_replay_service__WEBPACK_IMPORTED_MODULE_4__.ReplayService);
    this.modelerService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_tools_modeler_services_modeler_service__WEBPACK_IMPORTED_MODULE_10__.ModelerService);
    this.dirtyFlagService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_11__.DirtyFlagService);
    this.importDomainStoryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_import_services_import_domain_story_service__WEBPACK_IMPORTED_MODULE_17__.ImportDomainStoryService);
    this.activatedRoute = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_angular_router__WEBPACK_IMPORTED_MODULE_12__.ActivatedRoute);
    this.showSettings = this.settingsService.showSettings;
    this.importDomainStoryService.automatedImportSuccessFull$().pipe((0,_angular_core_rxjs_interop__WEBPACK_IMPORTED_MODULE_18__.takeUntilDestroyed)()).subscribe(() => {
    ...
    document.addEventListener(src_app_tools_modeler_diagram_js_features_diagramJSConstants__WEBPACK_IMPORTED_MODULE_19__.OPEN_COLOR_PICKER_EVENT, () => {
      this.colorPicker.openDialog();
    });
    document.addEventListener('errorColoringOnlySvg', () => {
      this.snackbar.open('Only SVG icons can be colored', undefined, {
        duration: _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.SNACKBAR_DURATION_LONG,
        panelClass: _domain_entities_constants__WEBPACK_IMPORTED_MODULE_8__.SNACKBAR_INFO
      });
    });
  }
  ngOnInit() {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_20__["ɵɵdefineComponent"]({
      ...
      viewQuery: function AppComponent_Query(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_20__["ɵɵviewQuery"](ngx_color_picker__WEBPACK_IMPORTED_MODULE_6__.ColorPickerDirective, 5);
        }
        if (rf & 2) {
          let _t;
      ...
      template: function AppComponent_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_20__["ɵɵadvance"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_20__["ɵɵclassProp"]("headerAndCanvas", !ctx.showSettings())("headerAndCanvasCollapsed", !ctx.showSettings())("hidden", ctx.showSettings());
      ...
      dependencies: [_workbench_presentation_header_header_header_component__WEBPACK_IMPORTED_MODULE_14__.HeaderComponent, _workbench_presentation_settings_settings_component__WEBPACK_IMPORTED_MODULE_15__.SettingsComponent, _tools_import_directive_dragDrop_directive__WEBPACK_IMPORTED_MODULE_16__.DragDirective, ngx_color_picker__WEBPACK_IMPORTED_MODULE_6__.ColorPickerDirective, _angular_router__WEBPACK_IMPORTED_MODULE_13__.RouterModule],
      styles: [".content[_ngcontent-%COMP%] {\n  height: 100%;\n  overflow: hidden;\n}\n\n\n.headerAndCanvas[_ngcontent-%COMP%] {\n  height: 100%;\n  width: 100%;\n  display: grid;\n  grid-template-rows: min-content auto;\n  overflow: hidden;\n}\n\n.headerAndCanvasCollapsed[_ngcontent-%COMP%] {\n  height: 100%;\n  width: 100%;\n  display: grid;\n  grid-template-rows: min-content auto;\n  overflow: hidden;\n}\n\n.settings[_ngcontent-%COMP%] {\n  height: 100%;\n}\n\n\n.logoContainer[_ngcontent-%COMP%] {\n  display: flex;\n  position: absolute;\n  bottom: 0;\n  right: 4px;\n  align-items: flex-end;\n  background-color: #f7f7f8;\n  margin-bottom: 4px;\n  border-width: 1px;\n  border-radius: 2px;\n  border-style: solid;\n  border-color: #b9bcc6;\n}\n.logoContainer[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  margin: 7px;\n  align-items: center;\n}\n\n.hidden[_ngcontent-%COMP%] {\n  height: 1px;\n  width: 1px;\n}\n\n.mat-button-toggle-label-content[_ngcontent-%COMP%] {\n  font-size: 10pt !important;\n  padding: 0 5px !important;\n  line-height: inherit !important;\n}\n\n .mdc-text-field--filled:not(.mdc-text-field--disabled) {\n  background-color: white;\n}\n\nspan[_ngcontent-%COMP%]   *[_ngcontent-%COMP%] {\n  vertical-align: middle;\n}\n\nspan[_ngcontent-%COMP%] {\n  height: 24px;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony export */ });
/** DEFAULT VALUES **/
const INITIAL_TITLE = 'Click to add title';
...
const DEFAULT_AUTOSAVES_MAX_DRAFTS = 20;
...
/***/ 84967
/*!**************************************************!*\
  !*** ./src/app/domain/entities/element-types.ts ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   Granularity_Goal: () => (/* binding */ Granularity_Goal),
/* harmony export */   Granularity_Grain: () => (/* binding */ Granularity_Grain),
...
/***/ 29408
/*!***************************************************************!*\
  !*** ./src/app/tools/activity/domain/activity-dialog-data.ts ***!
  \***************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 394
/*!***************************************************************!*\
  !*** ./src/app/tools/activity/domain/activity-dialog-form.ts ***!
  \***************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 98894
/*!**************************************************************************!*\
  !*** ./src/app/tools/activity/presentation/activity-dialog.component.ts ***!
  \**************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ 48015);
/* harmony import */ var src_app_tools_activity_domain_activity_dialog_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/tools/activity/domain/activity-dialog-form */ 394);
...
class ActivityDialogComponent {
  constructor() {
    ...
    this.form = src_app_tools_activity_domain_activity_dialog_form__WEBPACK_IMPORTED_MODULE_3__.ActivityDialogForm.create(this.activityLabel, this.activityNumber, this.numberIsAllowedMultipleTimes);
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__["ɵɵdefineComponent"]({
      ...
      styles: [".fullWidth[_ngcontent-%COMP%] {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/***/ 56115
/*!***************************************************************************!*\
  !*** ./src/app/tools/activity/services/activity-click-handler.service.ts ***!
  \***************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
/* harmony import */ var src_app_tools_activity_domain_activity_dialog_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/tools/activity/domain/activity-dialog-data */ 29408);
...
/* harmony import */ var src_app_tools_activity_presentation_activity_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/tools/activity/presentation/activity-dialog.component */ 98894);
/* harmony import */ var src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/tools/dialog/services/dialog.service */ 67787);
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
...
/* harmony import */ var src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/tools/modeler/services/command-stack.service */ 44005);
...
class ActivityClickHandlerService {
  constructor() {
    this.dialogService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_7__.DialogService);
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_8__.ElementRegistryService);
    this.commandStackService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_10__.CommandStackService);
  ...
  activityDoubleClick(activity) {
    ...
    if (activity.businessObject.number && source && source.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.ACTOR)) {
      config.data = new src_app_tools_activity_domain_activity_dialog_data__WEBPACK_IMPORTED_MODULE_4__.ActivityDialogData(activity, (0,src_app_tools_modeler_diagram_js_features_numbering_numbering__WEBPACK_IMPORTED_MODULE_5__.isNumberMultiple)(activity.businessObject.number), true, data => this.saveActivityInputLabel(data));
    } else if (source && source.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.WORKOBJECT)) {
      config.data = new src_app_tools_activity_domain_activity_dialog_data__WEBPACK_IMPORTED_MODULE_4__.ActivityDialogData(activity, false, false, activityData => this.saveActivityInputLabel(activityData));
    }
    this.dialogService.openDialog(src_app_tools_activity_presentation_activity_dialog_component__WEBPACK_IMPORTED_MODULE_6__.ActivityDialogComponent, config);
  }
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 38424);
/* harmony import */ var _utils_services_storage_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../utils/services/storage.service */ 61869);
...
class AutosaveConfigurationService {
  constructor() {
    ...
    this.storageService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_utils_services_storage_service__WEBPACK_IMPORTED_MODULE_1__.StorageService);
...
/* harmony import */ var _utils_services_storage_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../utils/services/storage.service */ 61869);
...
class AutosaveService {
  constructor() {
    ...
    this.storageService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_utils_services_storage_service__WEBPACK_IMPORTED_MODULE_4__.StorageService);
...
/***/ 67787
/*!*********************************************************!*\
  !*** ./src/app/tools/dialog/services/dialog.service.ts ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 38424);
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/material/dialog */ 72768);
/* harmony import */ var src_app_tools_keyboard_shortcuts_presentation_keyboard_shortcuts_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/tools/keyboard-shortcuts/presentation/keyboard-shortcuts-dialog.component */ 5186);
...
class DialogService {
  ...
  openKeyboardShortcutsDialog() {
    ...
    this.openDialog(src_app_tools_keyboard_shortcuts_presentation_keyboard_shortcuts_dialog_component__WEBPACK_IMPORTED_MODULE_2__.KeyboardShortcutsDialogComponent, config);
  }
  static {
...
class ExportDialogComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({
      ...
      styles: [".ml-2[_ngcontent-%COMP%] {\n  margin-left: 2rem;\n}\n\n.card[_ngcontent-%COMP%] {\n  border: var(--borderGray10) solid 2px;\n  border-radius: 2px;\n  padding: 0.5rem;\n  -webkit-user-select: none;  \n  user-select: none; \n}\n\n.number-input[_ngcontent-%COMP%] {\n  max-width: 1rem;\n  text-align: center;\n  height: 1rem;\n  align-self: center;\n  border: var(--borderGray10) solid 2px;\n  border-radius: 2px;\n  padding: 0 0.25rem;\n}\n\n.number-input[_ngcontent-%COMP%]:focus {\n  outline: none; \n  border-color: var(--borderGray10); \n  box-shadow: 0 0 5px var(--borderGray10); \n}\n\n.row[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  gap: 0.25rem;\n  cursor: pointer;\n}\n\ninput[_ngcontent-%COMP%] {\n  margin: 0;\n  padding: 0;\n}\n\n.input[_ngcontent-%COMP%] {\n  width: 50vw;\n}\n.input[_ngcontent-%COMP%]   mat-label[_ngcontent-%COMP%] {\n  font-size: 12pt;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
...
/* harmony import */ var src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/app/tools/dialog/services/dialog.service */ 67787);
...
class ExportService {
  constructor() {
    ...
    this.dirtyFlagService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_5__.DirtyFlagService);
    ...
    this.dialogService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_16__.DialogService);
  ...
  */
  downloadHTMLPresentation(filename) {
    ...
    return (0,_home_runner_work_egon_io_egon_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const revealjsData = {
        script: 'script',
        title: _this.propertiesService.title(),
        description: _this.propertiesService.description(),
        sentences: svgData,
...
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
/* harmony import */ var src_app_utils_sanitizer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/utils/sanitizer */ 43515);
...
class IconSetConfigurationComponent {
  constructor() {
    ...
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_4__.ElementRegistryService);
...
class IconDictionaryService {
  ...
  getIconsAssignedAs(type) {
    switch (type) {
      case src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTOR:
        return this.selectedActorsDictionary;
      case src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT:
...
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
class IconSetCustomizationService {
  constructor() {
    ...
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_3__.ElementRegistryService);
  ...
  deselectActor(actor) {
    ...
    this.iconDictionaryService.unregisterIconForType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR, actor);
    this.updateActorSignal();
  }
  deselectWorkObject(workObject) {
    ...
    this.iconDictionaryService.unregisterIconForType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT, workObject);
    this.updateWorkObjectSignal();
  }
  ...
  createIconSetFromCanvas() {
    ...
    allCanvasObjects.map(e => e.businessObject).forEach(element => {
      const type = element.type.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR, '').replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT, '');
      if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR)) {
        let src = this.iconDictionaryService.getIconSource(type) || '';
        config.actors.set(type, src);
      } else if (element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT)) {
        let src = this.iconDictionaryService.getIconSource(type) || '';
  ...
  getCurrentConfigurationNamesWithoutPrefix() {
    return {
      ...
      actors: this.iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR).keysArray().map(a => a.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR, '')),
      workObjects: this.iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT).keysArray().map(w => w.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT, ''))
    };
  }
  ...
  overrideSelectedIcons(changedIconSet) {
    ...
    changedIconSet.actors.keysArray().forEach(actor => {
      this.iconDictionaryService.registerIconForType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR, actor, this.iconDictionaryService.getFullDictionary().get(actor));
      this.iconDictionaryService.unregisterIconForType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT, actor);
      this.setAsActor(actor);
    });
    changedIconSet.workObjects.keysArray().forEach(workObject => {
      this.iconDictionaryService.registerIconForType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.WORKOBJECT, workObject, this.iconDictionaryService.getFullDictionary().get(workObject));
      this.iconDictionaryService.unregisterIconForType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_6__.ElementTypes.ACTOR, workObject);
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
/* harmony import */ var _domain_entities_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../domain/entities/constants */ 40550);
/* harmony import */ var _utils_services_storage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../utils/services/storage.service */ 61869);
...
class IconSetImportExportService {
  constructor() {
    ...
    this.storageService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_utils_services_storage_service__WEBPACK_IMPORTED_MODULE_5__.StorageService);
  ...
  getCurrentConfiguration() {
    const actors = this.iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.ACTOR);
    const workObjects = this.iconDictionaryService.getIconsAssignedAs(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.WORKOBJECT);
  ...
  createConfigFromDictionaries(actorsDict, workObjectsDict) {
    ...
    actorNames.forEach(actor => {
      newActors.set(actor.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.ACTOR, ''), actorsDict.get(actor));
    });
    workObjectNames.forEach(workObject => {
      newWorkObjects.set(workObject.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_3__.ElementTypes.WORKOBJECT, ''), workObjectsDict.get(workObject));
    });
    return {
...
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
...
class DragDirective {
  constructor() {
    ...
    this.dirtyFlagService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_4__.DirtyFlagService);
  }
  onDragOver(evt) {
    evt.preventDefault();
    evt.stopPropagation();
...
/* harmony import */ var src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/tools/dialog/services/dialog.service */ 67787);
...
/* harmony import */ var src_app_tools_unsaved_changes_reminder_presentation_unsaved_changes_reminder_dialog_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/tools/unsaved-changes-reminder/presentation/unsaved-changes-reminder-dialog.component */ 39546);
...
class ImportDomainStoryService {
  constructor() {
    ...
    this.dialogService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_4__.DialogService);
  ...
  openUnsavedChangesReminderDialog(fn) {
    ...
    config.autoFocus = true;
    config.data = fn;
    this.dialogService.openDialog(src_app_tools_unsaved_changes_reminder_presentation_unsaved_changes_reminder_dialog_component__WEBPACK_IMPORTED_MODULE_12__.UnsavedChangesReminderDialogComponent, config);
  }
...
class ImportRepairService {
  checkForUnreferencedElementsInActivitiesAndRepair(elements) {
    ...
    elements.forEach(element => {
      ...
      if (type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTIVITY || type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.CONNECTION) {
  ...
  updateCustomElementsPreviousV050(elements) {
    for (const element of elements) {
      if (element.type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT) {
        element.type = src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT + 'Document';
      } else if (element.type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT + 'Bubble') {
        element.type = src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT + 'Conversation';
      }
    }
    return elements;
  }
...
/***/ 5186
/*!**********************************************************************************************!*\
  !*** ./src/app/tools/keyboard-shortcuts/presentation/keyboard-shortcuts-dialog.component.ts ***!
  \**********************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class KeyboardShortcutsDialogComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
      ...
      styles: [".content[_ngcontent-%COMP%] {\n  height: fit-content;\n  width: 30vw;\n  overflow: hidden;\n}\n\n.row[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n}\n\n.description-width[_ngcontent-%COMP%] {\n  width: 12rem;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 38424);
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
...
/* harmony import */ var _domain_entities_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../domain/entities/constants */ 40550);
/* harmony import */ var src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/tools/dialog/services/dialog.service */ 67787);
/* harmony import */ var _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/material/snack-bar */ 40382);
...
class LabelDictionaryService {
  constructor() {
    ...
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_1__.ElementRegistryService);
    ...
    this.dialogService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_8__.DialogService);
  ...
  openLabelDictionary() {
    const isActivityWithLabel = element => element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY) && element.businessObject.name;
    const isWorkObjectWithLabel = element => element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT) && element.businessObject.name;
  ...
  createLabelDictionaries() {
    ...
    allObjects.forEach(element => {
      ...
      if (name && name.length > 0 && element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY) && !this.activityLabels.map(a => a.name).includes(name)) {
        this.activityLabels.push({
          name,
          originalName: name
        });
      } else if (name && name.length > 0 && element.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT) && !this.workObjektLabels.map(e => e.name).includes(name)) {
        const iconName = element.type.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT, '');
  ...
  massRenameLabels(activityNames, originalActivityNames, workObjectNames, originalWorkObjectNames) {
    for (let i = 0; i < originalActivityNames.length; i++) {
      ...
      if (!(activityNames[i] == originalActivityNames[i])) {
        this.massNamingService.massChangeNames(originalActivityNames[i], activityNames[i], src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY);
      }
    }
    for (let i = 0; i < originalWorkObjectNames.length; i++) {
      ...
      if (!(workObjectNames[i] == originalWorkObjectNames[i])) {
        this.massNamingService.massChangeNames(originalWorkObjectNames[i], workObjectNames[i], src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.WORKOBJECT);
      }
    }
  }
  static {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 38424);
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
/* harmony import */ var src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/tools/modeler/services/command-stack.service */ 44005);
...
class MassNamingService {
  constructor() {
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_1__.ElementRegistryService);
    this.commandStackService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_2__.CommandStackService);
  }
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 11525);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 38424);
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
...
function provideModeler() {
  return (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.provideAppInitializer)(() => {
    const dirtyFlagService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_2__.DirtyFlagService);
    ...
    const elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_4__.ElementRegistryService);
...
/***/ 44005
/*!*****************************************************************!*\
  !*** ./src/app/tools/modeler/services/command-stack.service.ts ***!
  \*****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class CopyPasteService {
  ...
  pasteElement(event) {
    ...
    if (event.descriptor.oldBusinessObject.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.TEXTANNOTATION)) {
  ...
  createEnd(event) {
    ...
    for (let elementsKey in event.elements) {
      ...
      if (element.businessObject.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.TEXTANNOTATION)) {
...
/***/ 186
/*!**************************************************************!*\
  !*** ./src/app/tools/modeler/services/dirty-flag.service.ts ***!
  \**************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 58367
/*!********************************************************************!*\
  !*** ./src/app/tools/modeler/services/element-registry.service.ts ***!
  \********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class ElementRegistryService {
  ...
  fillListOfCanvasObjects(allObjectsFromCanvas, objectList, groups) {
    allObjectsFromCanvas.forEach(canvasElement => {
      if (canvasElement.type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTIVITY) {
        objectList.push(canvasElement);
      }
      // ensure that Activities are always after Actors, WorkObjects and Groups in .dst files
      else {
        if (canvasElement.type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.TEXTANNOTATION) {
  ...
  getAllActivities() {
    return this.getObjectsOfType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTIVITY);
  }
  getAllConnections() {
    return this.getObjectsOfType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.CONNECTION);
  }
  getAllActors() {
    return this.getObjectsOfType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR);
  }
  getAllWorkObjects() {
    return this.getObjectsOfType(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT);
  }
  getAllCanvasObjects() {
    const allObjects = [];
    const groupObjects = [];
    ...
    while (groupObjects.length >= 1) {
      ...
      currentGroup?.children?.forEach(child => {
        ...
        if (type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.GROUP)) {
  ...
  getAllGroups() {
    ...
    for (const group of groupObjects) {
      group.children?.forEach(child => {
        if (child.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.GROUP)) {
          groupObjects.push(child);
        }
      });
    }
    ...
    if (this.registry) {
      ...
      for (const name of registryElementNames) {
        ...
        if (entry.businessObject) {
          ...
          if (type && type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.GROUP)) {
  ...
  getActivitiesFromActors() {
    ...
    activities.forEach(activity => {
      if (activity.source?.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR)) {
  ...
  getUsedIcons() {
    ...
    return {
      actors: actors.map(a => a.type.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.ACTOR, '')),
      workObjects: workObjects.map(w => w.type.replace(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_0__.ElementTypes.WORKOBJECT, ''))
    };
  }
  static {
...
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
/* harmony import */ var src_app_tools_properties_services_properties_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/tools/properties/services/properties.service */ 36787);
/* harmony import */ var src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/tools/modeler/services/command-stack.service */ 44005);
...
/* harmony import */ var src_app_tools_activity_services_activity_click_handler_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/tools/activity/services/activity-click-handler.service */ 56115);
...
class InitializerService {
  constructor() {
    ...
    this.commandStackService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_4__.CommandStackService);
    this.propertiesService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_properties_services_properties_service__WEBPACK_IMPORTED_MODULE_3__.PropertiesService);
    this.activityClickHandlerService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_activity_services_activity_click_handler_service__WEBPACK_IMPORTED_MODULE_10__.ActivityClickHandlerService);
  ...
  initiateEventBusListeners(eventBus) {
    eventBus.on(src_app_tools_modeler_diagram_js_features_diagramJSConstants__WEBPACK_IMPORTED_MODULE_12__.EVENT_ELEMENT_DBLCLICK, event => {
      if (!this.replayService.replayOn()) {
        ...
        if (element.type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY) {
...
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
...
/* harmony import */ var _icon_set_config_services_icon_set_import_export_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../icon-set-config/services/icon-set-import-export.service */ 93103);
/* harmony import */ var src_app_tools_modeler_diagram_js_features_numbering_numbering__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/tools/modeler/diagram-js/features/numbering/numbering */ 19955);
/* harmony import */ var _utils_services_storage_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../utils/services/storage.service */ 61869);
...
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
...
class ModelerService {
  constructor() {
    ...
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_5__.ElementRegistryService);
    ...
    this.dirtyFlagService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_13__.DirtyFlagService);
    this.storageService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_utils_services_storage_service__WEBPACK_IMPORTED_MODULE_9__.StorageService);
...
/***/ 71617
/*!************************************************************!*\
  !*** ./src/app/tools/properties/domain/properties-form.ts ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PropertiesForm: () => (/* binding */ PropertiesForm)
/* harmony export */ });
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/forms */ 48015);
...
/***/ 22463
/*!***********************************************************************!*\
  !*** ./src/app/tools/properties/presentation/properties.component.ts ***!
  \***********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ 48015);
/* harmony import */ var src_app_tools_properties_services_properties_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/tools/properties/services/properties.service */ 36787);
/* harmony import */ var src_app_tools_properties_domain_properties_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/tools/properties/domain/properties-form */ 71617);
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
...
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/material/core */ 17960);
/* harmony import */ var _angular_material_select__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/material/select */ 54136);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/core */ 11525);
/* harmony import */ var _angular_material_form_field__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/material/form-field */ 21662);
...
function PropertiesComponent_For_19_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](0, "mat-option", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
  }
  if (rf & 2) {
    const pit_r1 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵproperty"]("value", pit_r1.value);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](pit_r1.viewValue);
  }
}
function PropertiesComponent_For_27_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](0, "mat-option", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵproperty"]("value", dp_r2.value);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](dp_r2.viewValue);
  }
}
function PropertiesComponent_For_36_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](0, "mat-option", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
  ...
  if (rf & 2) {
    const grain_r3 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵproperty"]("value", grain_r3.value);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](grain_r3.viewValue);
  }
}
function PropertiesComponent_For_39_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](0, "mat-option", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵproperty"]("value", goal_r4.value);
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](goal_r4.viewValue);
  }
}
class PropertiesComponent {
  constructor() {
    ...
    this.changedFromExternal = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(false, ...(ngDevMode ? [{
      debugName: "changedFromExternal"
    }] : /* istanbul ignore next */[]));
    this.GranularityGrainValues = [{
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Grain.COARSE,
      viewValue: 'coarse'
    }, {
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Grain.MEDIUM,
      viewValue: 'medium'
    }, {
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Grain.FINE,
      viewValue: 'fine'
    }];
    this.GranularityGoalValues = [{
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Goal.CLOUD,
      viewValue: 'cloud'
    }, {
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Goal.KITE,
      viewValue: 'kite'
    }, {
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Goal.SEA,
      viewValue: 'sea'
    }, {
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.Granularity_Goal.FISH,
      viewValue: 'fish'
    }, {
    ...
    this.PointInTimeValues = [{
      ...
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.PointInTime.AS_IS,
      viewValue: 'as is'
    }];
    this.DomainPurityValues = [{
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.DomainPurity.PURE,
      viewValue: 'pure'
    }, {
      value: src_app_domain_entities_scope__WEBPACK_IMPORTED_MODULE_9__.DomainPurity.DIGITALIZED,
      viewValue: 'digitalized'
    }];
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.effect)(() => {
    ...
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.effect)(() => {
      this.changedFromExternal.set(true);
      this.form.controls.description.patchValue(this.propertiesService.description());
    });
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.effect)(() => {
      this.changedFromExternal.set(true);
      const pointInTime = this.propertiesService.scope()?.pointInTime;
      this.form.controls.pointInTime.patchValue(pointInTime ? pointInTime : null);
    });
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.effect)(() => {
      this.changedFromExternal.set(true);
      const domainPurity = this.propertiesService.scope()?.domainPurity;
      this.form.controls.domainPurity.patchValue(domainPurity ? domainPurity : null);
    });
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.effect)(() => {
      this.changedFromExternal.set(true);
      const granularity = this.propertiesService.scope()?.granularity;
      this.form.controls.granularity.patchValue(granularity ? granularity : null);
    });
  }
  ngOnInit() {
    ...
    this.form = src_app_tools_properties_domain_properties_form__WEBPACK_IMPORTED_MODULE_4__.PropertiesForm.create(title(), description(), scope?.granularity ? scope.granularity : null, scope?.pointInTime ? scope.pointInTime : null, scope?.domainPurity ? scope.domainPurity : null);
  ...
  static {
    this.ɵfac = function PropertiesComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || PropertiesComponent)();
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({
      ...
      template: function PropertiesComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](5, "Title");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelement"](6, "input", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](7, "mat-form-field", 3)(8, "mat-label");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](9, "Description");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](10, "textarea", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("keydown.enter", function PropertiesComponent_Template_textarea_keydown_enter_10_listener($event) {
            return ctx.preventDefault($event);
          })("keyup.enter", function PropertiesComponent_Template_textarea_keyup_enter_10_listener() {
            return ctx.save();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]()()();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](11, "div", 6)(12, "mat-form-field", 3)(13, "mat-label");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](14, "Point In Time");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](15, "mat-select", 7)(16, "mat-option");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](17, "-- None --");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterCreate"](18, PropertiesComponent_For_19_Template, 2, 2, "mat-option", 8, _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterTrackByIdentity"]);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](20, "mat-form-field", 3)(21, "mat-label");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](22, "Domain Purity");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](23, "mat-select", 9)(24, "mat-option");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](25, "-- None --");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterCreate"](26, PropertiesComponent_For_27_Template, 2, 2, "mat-option", 8, _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterTrackByIdentity"]);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](28, "mat-form-field", 3)(29, "mat-label");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](30, "Granularity");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](31, "mat-select", 10)(32, "mat-option");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](33, "-- None --");
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](34, "mat-optgroup", 11);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterCreate"](35, PropertiesComponent_For_36_Template, 2, 2, "mat-option", 8, _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterTrackByIdentity"]);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](37, "mat-optgroup", 12);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterCreate"](38, PropertiesComponent_For_39_Template, 2, 2, "mat-option", 8, _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeaterTrackByIdentity"]);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]()()()()()();
        }
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeater"](ctx.PointInTimeValues);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](8);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeater"](ctx.DomainPurityValues);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](9);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeater"](ctx.GranularityGrainValues);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](3);
          _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵrepeater"](ctx.GranularityGoalValues);
        }
      },
      dependencies: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.ReactiveFormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.MaxLengthValidator, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroupDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControlName, _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__.MatDialogModule, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_6__.MatFormFieldModule, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_13__.MatFormField, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_13__.MatLabel, _angular_material_input__WEBPACK_IMPORTED_MODULE_7__.MatInputModule, _angular_material_input__WEBPACK_IMPORTED_MODULE_7__.MatInput, _angular_material_button__WEBPACK_IMPORTED_MODULE_8__.MatButtonModule, _angular_material_core__WEBPACK_IMPORTED_MODULE_10__.MatOption, _angular_material_select__WEBPACK_IMPORTED_MODULE_11__.MatSelect, _angular_material_core__WEBPACK_IMPORTED_MODULE_10__.MatOptgroup],
      styles: [".description[_ngcontent-%COMP%] {\n  min-height: 88px;\n}\n\n .isSelected button {\n  background-color: #a4d7e1;\n}\n\n.wrapper[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 75% auto;\n  gap: 0.5rem;\n}\n\n.TitleAndDescription[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n\n.Scope[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class PropertiesService {
  constructor() {
    this.commandStackService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_command_stack_service__WEBPACK_IMPORTED_MODULE_2__.CommandStackService);
    this.titleSignal = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(_domain_entities_constants__WEBPACK_IMPORTED_MODULE_1__.INITIAL_TITLE, ...(ngDevMode ? [{
    ...
    this.descriptionSignal = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(_domain_entities_constants__WEBPACK_IMPORTED_MODULE_1__.INITIAL_DESCRIPTION, ...(ngDevMode ? [{
      debugName: "descriptionSignal"
    }] : /* istanbul ignore next */[]));
    this.title = this.titleSignal.asReadonly();
    this.description = this.descriptionSignal.asReadonly();
    this.scope = this.scopeSignal.asReadonly();
  }
  ...
  reset() {
    this.updateTitleAndDescriptionAndScope(_domain_entities_constants__WEBPACK_IMPORTED_MODULE_1__.INITIAL_TITLE, _domain_entities_constants__WEBPACK_IMPORTED_MODULE_1__.INITIAL_DESCRIPTION, undefined, false);
  }
  ...
  hasTitleOrDescription() {
    return this.title().trim().length > 0 && this.title() !== _domain_entities_constants__WEBPACK_IMPORTED_MODULE_1__.INITIAL_TITLE || this.description().trim().length > 0 && this.description() !== _domain_entities_constants__WEBPACK_IMPORTED_MODULE_1__.INITIAL_DESCRIPTION;
  }
...
class DomManipulationService {
  ...
  highlightSentence(sentenceObjects) {
    sentenceObjects.filter(e => e.type === src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_2__.ElementTypes.ACTIVITY).forEach(activity => {
      const querySelector = document.querySelector(QUERY_SELECTOR_PREFIX + activity.id + QUERY_SELECTOR_POSTFIX);
      if (querySelector) {
        const activityDomObject = querySelector.getElementsByTagName(_domain_replayConstants__WEBPACK_IMPORTED_MODULE_3__.CONNECTION_PATH_DOM_SELECTOR)[0];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 38424);
/* harmony import */ var src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/domain/entities/element-types */ 84967);
/* harmony import */ var src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/tools/modeler/services/element-registry.service */ 58367);
...
class StoryCreatorService {
  constructor() {
    this.elementRegistryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_element_registry_service__WEBPACK_IMPORTED_MODULE_2__.ElementRegistryService);
  }
  ...
  getMissingSentences(story) {
    ...
    const allActivityNumbersFromActors = story.map(sentence => {
      ...
      const allActivityNumbers = sentence.objects.map(businessObject => {
        if (businessObject.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.ACTIVITY)) {
  ...
  getSentenceObjects(tracedActivity) {
    ...
    tracedActivity.forEach(parallelSentence => {
      ...
      for (const checkTarget of parallelSentenceTargetObjects) {
        if (checkTarget.businessObject && !checkTarget.businessObject.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.ACTOR) && checkTarget.outgoing) {
    ...
    actorsAndWorkObjects.forEach(object => {
      if (object.businessObject.type.includes(src_app_domain_entities_element_types__WEBPACK_IMPORTED_MODULE_1__.ElementTypes.ACTOR)) {
...
/***/ 39546
/*!**********************************************************************************************************!*\
  !*** ./src/app/tools/unsaved-changes-reminder/presentation/unsaved-changes-reminder-dialog.component.ts ***!
  \**********************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   UnsavedChangesReminderDialogComponent: () => (/* binding */ UnsavedChangesReminderDialogComponent)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 38424);
...
class UnsavedChangesReminderDialogComponent {
  constructor() {
  ...
  static {
    this.ɵfac = function UnsavedChangesReminderDialogComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || UnsavedChangesReminderDialogComponent)();
    };
  }
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      type: UnsavedChangesReminderDialogComponent,
      selectors: [["app-unsaved-changes-reminder"]],
      decls: 13,
      vars: 0,
      consts: [["type", "button", "mat-flat-button", "", 3, "click"], ["type", "button", "mat-flat-button", "", "color", "primary", 3, "click"]],
      template: function UnsavedChangesReminderDialogComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "mat-dialog-content")(1, "label")(2, "h2");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](3, "Attention");
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]()();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function UnsavedChangesReminderDialogComponent_Template_button_click_9_listener() {
            return ctx.close();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function UnsavedChangesReminderDialogComponent_Template_button_click_11_listener() {
...
/* harmony import */ var _angular_material_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material/button */ 95912);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common */ 55279);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/core */ 11525);
...
function HeaderButtonsComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_1_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](3, " play_arrow ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](4, " Replay ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](5, "button", 3)(6, "span", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](7, " file_upload ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](8, " Import file ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](9, "button", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_9_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](11, " cloud_upload ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](12, " Import URL ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](13, "input", 5);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("change", function HeaderButtonsComponent_Conditional_0_Template_input_change_13_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_14_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](17, " Export ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](18, "button", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_18_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵresetView"](ctx_r1.openLabelDictionary.emit());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](19, "span", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](20, " spellcheck ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](21, " Dictionary ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](22, "button", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_22_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](24, " note_add ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](25, " New story ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](26, "button", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_26_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](28, " settings ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_0_Template_button_click_30_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r1);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](32, " keyboard ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](33, " Shortcuts ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]()();
  }
  if (rf & 2) {
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵclassProp"]("disabled", !ctx_r1.isReplayable());
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("disabled", !ctx_r1.isReplayable());
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](13);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵclassProp"]("disabled", !ctx_r1.hasDomainStory() && !ctx_r1.hasTitle())("dirty", ctx_r1.isDirty());
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("disabled", !ctx_r1.hasDomainStory() && !ctx_r1.hasTitle());
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵclassProp"]("disabled", !ctx_r1.hasDomainStory());
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵproperty"]("disabled", !ctx_r1.hasDomainStory());
  }
}
function HeaderButtonsComponent_Conditional_1_Conditional_1_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_1_Conditional_1_Conditional_0_Template_button_click_0_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](1, "span", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](2, " visibility_off ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](3, " Groups ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
  }
}
function HeaderButtonsComponent_Conditional_1_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_1_Conditional_1_Conditional_1_Template_button_click_0_listener() {
...
function HeaderButtonsComponent_Conditional_1_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵconditionalCreate"](0, HeaderButtonsComponent_Conditional_1_Conditional_1_Conditional_0_Template, 4, 0, "button", 15)(1, HeaderButtonsComponent_Conditional_1_Conditional_1_Conditional_1_Template, 4, 0, "button", 16);
  }
  if (rf & 2) {
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵconditional"](ctx_r1.showGroups() ? 0 : 1);
  }
}
function HeaderButtonsComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵconditionalCreate"](1, HeaderButtonsComponent_Conditional_1_Conditional_1_Template, 2, 1);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](2, "button", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_1_Template_button_click_2_listener() {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](4, " skip_previous ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](5, " Prev. ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](6, "button", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_1_Template_button_click_6_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](8, " skip_next ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](9, " Next ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](10, "button", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function HeaderButtonsComponent_Conditional_1_Template_button_click_10_listener() {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3);
      const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
      return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵresetView"](ctx_r1.stopReplay.emit());
    });
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementStart"](11, "span", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](12, " stop ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtext"](13, " Stop ");
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵelementEnd"]();
  ...
  if (rf & 2) {
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵconditional"](ctx_r1.hasGroups() ? 1 : -1);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵadvance"](14);
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵtextInterpolate1"]("Sentence: ", ctx_r1.sentenceDescription());
  }
}
class HeaderButtonsComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "replaying"], ["matButton", "", "id", "buttonStartReplay", "title", "Start replay", 3, "click", "disabled"], [1, "material-icons-outlined", "buttonIcon"], ["matButton", "", "id", "buttonImport", "title", "Import story from file", "onclick", "document.getElementById('import').click()"], ["matButton", "", "id", "buttonUrlImport", "title", "Import story from URL", 3, "click"], ["type", "file", "accept", ".dst, .egn, .svg", "id", "import", "onclick", "this.value = null", 2, "display", "none", 3, "change"], ["matButton", "", "id", "export", "title", "Export story as .egn, .svg or .png file", 3, "click", "disabled"], ["matButton", "", "title", "Change multiple labels at once", 3, "click", "disabled"], ["matButton", "", "title", "Create a new domain story", 3, "click"], ["matButton", "", "title", "Change Icons and Settings", 3, "click"], ["matButton", "", "title", "Show keyboard shortcuts", 3, "click"], ["matButton", "", "title", "Previous sentence", 3, "click"], ["matButton", "", "title", "Next sentence", 3, "click"], ["matButton", "", "title", "Stop replay", 3, "click"], [1, "sentences"], ["matButton", "", "title", "Hide groups"], ["matButton", "", "title", "Show groups"], ["matButton", "", "title", "Hide groups", 3, "click"], ["matButton", "", "title", "Show groups", 3, "click"]],
      template: function HeaderButtonsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵconditionalCreate"](0, HeaderButtonsComponent_Conditional_0_Template, 34, 11, "div")(1, HeaderButtonsComponent_Conditional_1_Template, 16, 2, "div", 0);
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵconditional"](!ctx.isReplaying() ? 0 : 1);
        }
      },
      dependencies: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_4__.MatButtonModule, _angular_material_button__WEBPACK_IMPORTED_MODULE_4__.MatButton],
      styles: [".disabled[_ngcontent-%COMP%], \n.disabled[_ngcontent-%COMP%]   span[_ngcontent-%COMP%], \n.disabled[_ngcontent-%COMP%]:hover   span[_ngcontent-%COMP%] {\n  cursor: initial;\n  color: gray;\n}\n\n.dirty[_ngcontent-%COMP%] {\n  color: #b64435;\n}\n\n.dirty[_ngcontent-%COMP%]:hover {\n  color: #0093ac;\n}\n\n.replaying[_ngcontent-%COMP%] {\n  display: flex;\n}\n\n\n.sentences[_ngcontent-%COMP%] {\n  align-self: center;\n  margin-left: 16px;\n  width: 150px;\n  font-size: medium;\n  color: black;\n}\n\nbutton[_ngcontent-%COMP%] {\n  padding: 0 6px 0 0px;\n  letter-spacing: 0.05em;\n}\n\n.buttonIcon[_ngcontent-%COMP%] {\n  font-weight: 100;\n  vertical-align: middle;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
/* harmony import */ var src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/tools/modeler/services/dirty-flag.service */ 186);
/* harmony import */ var src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/tools/dialog/services/dialog.service */ 67787);
...
/* harmony import */ var _tools_label_dictionary_services_label_dictionary_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../tools/label-dictionary/services/label-dictionary.service */ 69731);
/* harmony import */ var src_app_tools_modeler_services_modeler_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/tools/modeler/services/modeler.service */ 40439);
...
/* harmony import */ var src_app_tools_properties_presentation_properties_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/tools/properties/presentation/properties.component */ 22463);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @angular/core */ 11525);
...
class HeaderComponent {
  constructor() {
    this.propertiesService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_properties_services_properties_service__WEBPACK_IMPORTED_MODULE_2__.PropertiesService);
    this.replayService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_tools_replay_services_replay_service__WEBPACK_IMPORTED_MODULE_3__.ReplayService);
    this.importService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_tools_import_services_import_domain_story_service__WEBPACK_IMPORTED_MODULE_4__.ImportDomainStoryService);
    this.settingsService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_services_settings_settings_service__WEBPACK_IMPORTED_MODULE_5__.SettingsService);
    this.modelerService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_modeler_service__WEBPACK_IMPORTED_MODULE_10__.ModelerService);
    this.dirtyFlagService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_modeler_services_dirty_flag_service__WEBPACK_IMPORTED_MODULE_6__.DirtyFlagService);
    this.dialogService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(src_app_tools_dialog_services_dialog_service__WEBPACK_IMPORTED_MODULE_7__.DialogService);
    this.exportService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_tools_export_services_export_service__WEBPACK_IMPORTED_MODULE_8__.ExportService);
    this.labelDictionaryService = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.inject)(_tools_label_dictionary_services_label_dictionary_service__WEBPACK_IMPORTED_MODULE_9__.LabelDictionaryService);
    ...
    this.title = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.computed)(() => {
      const title = this.propertiesService.title();
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵdefineComponent"]({
      ...
      decls: 7,
      vars: 8,
      consts: [[1, "headline"], [1, "nowrap", 3, "import", "openSettings", "startReplay", "stopReplay", "nextSentence", "previousSentence", "toggleGroups", "newStory", "showKeyboardShortCuts", "openLabelDictionary", "openDownloadDialog", "openImportFromUrlDialog", "click", "hasDomainStory", "hasTitle", "isDirty", "isReplayable", "isReplaying", "showGroups", "hasGroups"]],
      template: function HeaderComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵelementStart"](0, "mat-expansion-panel")(1, "mat-expansion-panel-header")(2, "mat-panel-title", 0);
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵtext"](3);
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵelementEnd"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵelementStart"](4, "mat-panel-description")(5, "app-header-buttons", 1);
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵlistener"]("import", function HeaderComponent_Template_app_header_buttons_import_5_listener() {
            return ctx.onImport();
          })("openSettings", function HeaderComponent_Template_app_header_buttons_openSettings_5_listener() {
            return ctx.openSettings();
          })("startReplay", function HeaderComponent_Template_app_header_buttons_startReplay_5_listener() {
            return ctx.startReplay();
          })("stopReplay", function HeaderComponent_Template_app_header_buttons_stopReplay_5_listener() {
            return ctx.stopReplay();
          })("nextSentence", function HeaderComponent_Template_app_header_buttons_nextSentence_5_listener() {
            return ctx.nextSentence();
          })("previousSentence", function HeaderComponent_Template_app_header_buttons_previousSentence_5_listener() {
            return ctx.previousSentence();
          })("toggleGroups", function HeaderComponent_Template_app_header_buttons_toggleGroups_5_listener() {
            return ctx.toggleGroups();
          })("newStory", function HeaderComponent_Template_app_header_buttons_newStory_5_listener() {
            return ctx.createNewDomainStory();
          })("showKeyboardShortCuts", function HeaderComponent_Template_app_header_buttons_showKeyboardShortCuts_5_listener() {
            return ctx.openKeyboardShortcutsDialog();
          })("openLabelDictionary", function HeaderComponent_Template_app_header_buttons_openLabelDictionary_5_listener() {
            return ctx.openLabelDictionary();
          })("openDownloadDialog", function HeaderComponent_Template_app_header_buttons_openDownloadDialog_5_listener() {
            return ctx.openDownloadDialog();
          })("openImportFromUrlDialog", function HeaderComponent_Template_app_header_buttons_openImportFromUrlDialog_5_listener() {
            return ctx.openImportFromUrlDialog();
          })("click", function HeaderComponent_Template_app_header_buttons_click_5_listener($event) {
            return $event.stopPropagation();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵelementEnd"]()()();
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵelement"](6, "app-properties-dialog");
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵelementEnd"]();
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵadvance"](3);
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵtextInterpolate1"](" ", ctx.title(), " ");
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵadvance"](2);
          _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵproperty"]("hasDomainStory", ctx.hasDomainStory)("hasTitle", ctx.hasTitle)("isDirty", ctx.isDirty())("isReplayable", ctx.isReplayable)("isReplaying", ctx.isReplayOn())("showGroups", ctx.showGroups())("hasGroups", ctx.hasGroups());
        }
      },
      dependencies: [_angular_material_toolbar__WEBPACK_IMPORTED_MODULE_11__.MatToolbarModule, _angular_material_card__WEBPACK_IMPORTED_MODULE_12__.MatCardModule, _header_buttons_header_buttons_component__WEBPACK_IMPORTED_MODULE_13__.HeaderButtonsComponent, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__.MatExpansionPanel, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__.MatExpansionPanelHeader, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__.MatExpansionPanelTitle, _angular_material_expansion__WEBPACK_IMPORTED_MODULE_14__.MatExpansionPanelDescription, src_app_tools_properties_presentation_properties_component__WEBPACK_IMPORTED_MODULE_15__.PropertiesComponent],
      styles: [".mat-expansion-panel-header[_ngcontent-%COMP%] {\n  flex-direction: row-reverse;\n  gap: 0.5rem;\n  padding-top: 0;\n  padding-bottom: 0;\n  padding-right: 0;\n  padding-left: 12px;\n}\n\n.mat-expansion-panel-header-description[_ngcontent-%COMP%] {\n  flex-direction: row-reverse;\n}\n\n.nowrap[_ngcontent-%COMP%] {\n  white-space: nowrap;\n}\n\n.headline[_ngcontent-%COMP%] {\n  min-width: 30%;\n  font-size: medium;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
...
class SettingsComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
      ...
      decls: 14,
      vars: 6,
      consts: [[1, "settings"], [1, "header"], ["type", "button", "mat-button", "", 1, "headerButton", "tab-small", 3, "click"], [1, "material-icons-outlined", "alignedWithText"], ["type", "button", "mat-button", "", 1, "headerButton", "tab-like", 3, "click"], [1, "headline"]],
      template: function SettingsComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](0, "div", 0)(1, "mat-toolbar", 1)(2, "button", 2);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function SettingsComponent_Template_button_click_2_listener() {
            return ctx.close();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](3, "span", 3);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtext"](4, "chevron_left");
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementEnd"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function SettingsComponent_Template_button_click_6_listener() {
            return ctx.openIconSetCustomization();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](7, "span", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtext"](8, "Customize Icon Set");
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementEnd"]()();
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](9, "button", 4);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵlistener"]("click", function SettingsComponent_Template_button_click_9_listener() {
            return ctx.openGeneralSettings();
          });
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementStart"](10, "span", 5);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵtext"](11, "Autosave Settings");
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementEnd"]()()();
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵconditionalCreate"](12, SettingsComponent_Conditional_12_Template, 1, 0, "app-autosave-settings");
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵconditionalCreate"](13, SettingsComponent_Conditional_13_Template, 1, 0, "app-icon-set-configuration");
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵelementEnd"]();
        }
        if (rf & 2) {
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵadvance"](6);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵadvance"](3);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵconditional"](ctx.showAutosaveSettings() ? 12 : -1);
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵadvance"]();
          _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵconditional"](ctx.showIconSetCustomization() ? 13 : -1);
        }
      },
      ...
      styles: [".header[_ngcontent-%COMP%] {\n  height: 40px;\n  padding: 0;\n  border-top: 0;\n  border-left: 0;\n  border-right: 0;\n  border-bottom: 1px;\n  border-color: #b9bcc6;\n  border-radius: 2px;\n  border-style: solid;\n}\n\n.tab-like[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  border-radius: 0;\n  font-size: medium;\n}\n\n.tab-small[_ngcontent-%COMP%] {\n  height: 100%;\n  width: 200px;\n  border-radius: 0;\n  font-size: medium;\n}\n\n.settings[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-rows: 40px auto;\n  width: 100%;\n  height: 100%;\n}\n\n.highlight[_ngcontent-%COMP%] {\n  background-color: #a4d7e1;\n}\n\n.alignedWithText[_ngcontent-%COMP%] {\n  vertical-align: middle;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    });
  }
}
